...
export class Board extends Sprite {
  ...
  setBroken() {
    ...
    new TWEEN.Tween(this.fragments1)
      .to({ x: 150, y: -2, rotation: this.fragments1.rotation + 3},25)
      .onComplete(() => {
        new TWEEN.Tween(this.fragments1)
    ...
    new TWEEN.Tween(this.fragments2)
      ...
      .onComplete(() => {
        new TWEEN.Tween(this.fragments2)
          .to({ x: 700, y: 1250, rotation: this.fragments2.rotation + 3 },50)
          .start(this.currentDt);
      })
      .start(this.currentDt);
    ...
    new TWEEN.Tween(this.fragments3)
      ...
      .onComplete(() => {
        new TWEEN.Tween(this.fragments3)
          .to({ x: -600, y: 1350, rotation:this.fragments3.rotation -5 },50)
          .start(this.currentDt);
      })
      .start(this.currentDt);
  ...
  setBroken2() {
    ...
    // set rơi manh 1
    new TWEEN.Tween(this.fragments1)
      .to({ x: -120, y: -170, rotation: this.fragments1.rotation + 3},20)
      .onComplete(() => {
        new TWEEN.Tween(this.fragments1)
          .to({ x: -680, y: -320, rotation:this.fragments1.rotation + 4 },25)
          .start(this.currentDt);
      })
      .start(this.currentDt);
    ...
    // set rơi manh 2
    new TWEEN.Tween(this.fragments2)
      .to({ x: 200, y: -230, rotation:this.fragments2.rotation + 2 },25)
      .onComplete(() => {
        new TWEEN.Tween(this.fragments2)
          .to({ x: 600, y: -620, rotation: this.fragments2.rotation + 3 },40)
          .start(this.currentDt);
      })
      .start(this.currentDt);
